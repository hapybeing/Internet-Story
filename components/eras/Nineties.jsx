...
const STATS = [
  ...
  { value: '23K', label: 'Websites in \'95' },
]
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          zIndex: 40,
          background: 'radial-gradient(ellipse at 50% 50%, transparent 40%, rgba(0,0,0,0.92) 100%)',
        }}
      />
      ...
      <div
        className="absolute inset-0 pointer-events-none"
        style={{ zIndex: 30, background: 'rgba(0, 20, 0, 0.25)', mixBlendMode: 'multiply' }}
      />

      <div className="era-watermark" style={{ fontFamily: 'var(--font-press-start)', color: '#00ff41' }}>
        1990s
      </div>
      ...
      <div className="relative h-full grid" style={{ gridTemplateColumns: '1fr 1fr', zIndex: 10 }}>
        ...
        <div className="flex flex-col justify-center overflow-hidden" style={{ padding: 'clamp(24px, 5vw, 64px) clamp(16px, 4vw, 48px)' }}>
          ...
          <h1
            ...
            style={{
              fontFamily: 'var(--font-press-start)',
              fontSize: 'clamp(16px, 3.2vw, 46px)',
              color: '#00ff41',
              lineHeight: 1.45,
              marginBottom: '28px',
            }}
        ...
        {/* RIGHT COLUMN */}
        <div
          className="flex flex-col justify-center overflow-hidden gap-4"
          ...
          <div ref={win95Ref} style={{ maxWidth: '500px', width: '100%' }}>
            <div className="win95-window">
              ...
              <div className="win95-menubar">
                {['File', 'Edit', 'View', 'Go', 'Bookmarks', 'Options', 'Help'].map((m) => (
              ...
              <div style={{ background: '#fff', padding: '10px 12px', minHeight: '120px', fontSize: '11px', color: '#000' }}>
                <div style={{ textAlign: 'center', fontSize: 'clamp(18px, 3vw, 28px)', fontWeight: '900', color: '#6600cc', fontFamily: 'Times New Roman, serif', marginBottom: '6px' }}>
                  ...
                  <span style={{ color: '#009900' }}>o</span>
                  <span style={{ color: '#0066ff' }}>o</span>
